...
ActiveRecord::Schema[7.1].define(version: 2024_06_26_075255) do
  ...
  create_table "authentications", force: :cascade do |t|
    ...
    t.index ["provider", "line_user_id"], name: "index_authentications_on_provider_and_line_user_id", unique: true
